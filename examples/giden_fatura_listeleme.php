<?php
    ...
    if(isset($elogo_login->sessionID)){
        ...
        //BU KODLAR SİZİN BAŞKA FİRMARALARA KESMİŞ OLDUĞUNUZ FATURALARIN LİSTESİNİ ALABİLİYORSUNUZ.

        $gelen_efaturalar = $elogo->giden_efaturalar('2023-03-01', '2023-03-31');
        ...
        $gelen_earsivler = $elogo->giden_earsivler('2023-03-01');
