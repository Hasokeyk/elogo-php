<?php
	...
	class Fatura{
		...
		private $kdv_muhafiyet_kodulari = [201, 202, 204, 205, 206, 207, 208, 209, 211, 212, 213, 214, 215, 216, 217, 218, 219, 220, 221, 223, 225, 226, 227, 228, 229, 230, 231, 232, 234, 235, 236, 237, 238, 239, 240, 250,];
		...
		public function getUrunler(){
			...
			$toplam_tutar                  = 0;
			$toplam_kdv_tutari             = 0;
			$toplam_konaklama_vergi_tutari = 0;
			...
			if(isset($this->urunler->urunler) and $this->urunler->urunler != null){
				foreach($this->urunler->urunler as $urun){
					...
					$toplam_konaklama_vergi_tutari += (($urun['urun_birim_fiyat'] * $urun['urun_adet']) - ($urun['urun_indirim_tutari'] ?? 0)) * (($urun['urun_konaklama_vergi_orani'] ?? ($this->konaklamaVergiOrani)) / 100);
			...
			$this->fatura_konaklama_vergi_tutari = $toplam_konaklama_vergi_tutari;
			$this->fatura_indirim_tutari         = $toplam_indirim_tutari;
			$this->fatura_genel_toplam           = round((($toplam_tutar - $toplam_indirim_tutari) + $toplam_kdv_tutari + $toplam_konaklama_vergi_tutari),2);
			//FİYAT TOPLA
		 ...
		 * @return mixed
		 */
		public function getKonaklamaVergiOrani(){
			return $this->konaklamaVergiOrani;
		}

		/**
		 * @param mixed $konaklama
		 */
		public function setKonaklamaVergiOrani($konaklamaVergiOrani){
			$this->konaklamaVergiOrani = $konaklamaVergiOrani;
		}
